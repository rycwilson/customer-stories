module SeedData
  ...
  CUSTOMERS = [
    ...
    customer_data.merge(description: Faker::Lorem.paragraph(sentence_count: 3, supplemental: true, random_sentences_to_add: 2))
  end
  ...
  CONTRIBUTOR_ROLES = ['Customer', 'Customer Success', 'Sales']

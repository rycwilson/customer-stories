class User < ApplicationRecord
  ...
  validates(:sign_up_code, on: :create, presence: { message: "can't be blank" },
                           inclusion: { in: ['csp_beta'], message: 'is invalid' })
  ...
  after_update_commit do
    ...
    S3Util.delete_object(S3_BUCKET, previous_changes[:photo_url].first) if photo_was_updated
  end

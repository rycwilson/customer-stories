...
####Certificate
Heroku recommends [DNSimple](https://support.dnsimple.com/articles/ssl-certificate-with-heroku/)

####GoDaddy DNS
GoDaddy is only our registrar. Nameservers point to DNSimple, which manages the DNS records
...
- only need www/* custom domain (delete the other)
